...
const Footer = () => {
  return (
    <section className="min-h-screen place-content-end" style={style}>
      <div className="flex flex-col gap-10 relative bottom-9">
        ...
        <Link to="pricing" smooth={true} duration={700} className="mx-auto">
          <Button className="w-56 h-14 font-bold bg-gray-400">
            BUY NOW!
          </Button>
        </Link>
        ...
        <div>
          ...
          >
            <AccordionItem value="item-1" className="border-gray-400">
              ...
              <AccordionContent>
                ReezeBolt Trio is the ultimate 3-in-1 portable device designed
                for power, comfort, and light — anytime, anywhere. This
                innovative device combines essential functionalities to provide
                reliable power, lighting, and cooling. Whether you're a student,
                an outdoor enthusiast, or someone facing frequent power outages,
                ReezeBolt Trio ensures you stay powered up and comfortable no
            ...
            <AccordionItem value="item-2" className="border-gray-400">
              ...
              <AccordionContent>
                ReezeBolt Trio is compact and lightweight, making it easy to
                carry wherever you go. It’s designed to fit into most backpacks,
                allowing you to take it along with you on the go, whether you’re
                traveling, camping, or just moving around your home or dorm.
              </AccordionContent>
            </AccordionItem>

            <AccordionItem value="item-3" className="border-gray-400">
              <AccordionTrigger>
                How do I charge the ReezeBolt Trio?
              </AccordionTrigger>
              <AccordionContent>
                ReezeBolt Trio can be easily charged using a standard USB-C or
                micro-USB charging cable. It charges quickly and can be
                recharged using a wall adapter or even a solar panel for outdoor
                usage.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-4" className="border-gray-400">
              ...
              <AccordionContent>
                Yes! You can use all three features of the ReezeBolt Trio at the
                same time. Charge your devices, enjoy the light, and stay cool
                with the fan — all from a single portable device.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
        ...
        <h6 className="text-center text-xs md:text-sm">
          Copyright @ 2024 Reezebolt. All rights reserved.
        </h6>
      </div>
    </section>
  );
